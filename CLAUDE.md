...
- `InputsData` snapshots `source_kind`, `source_text`, `cleaned_text`,
...
- `ProducedBy` — canonical grammar for `produced_by`: deterministic stages emit
  `jpresume/0.5.0`, LLM stages emit `jpresume/0.5.0 anthropic:claude-sonnet-4-6`,
